...
// resolves: Studio's published router registers a route per page and removes its catch-all once
// they're in, so a route with no page aborts the navigation with a toast. It redirects to the
// first module in the rail.
